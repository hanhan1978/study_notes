...
C言語では、全ての引数は値渡しです。  
ですが、ポインタを活用することで、参照を渡すことが出来ます。

Web系で利用する言語群は、参照渡しをサポートしています。  
というか、当然の事として、関数の戻り値とかは参照で渡してきます。
...
## ポインターの宣言2
これは、初心者キラーです。ポインターの宣言時は、値をセット出来ないのです。
```
